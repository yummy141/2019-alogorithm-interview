目录
---
<!-- TOC -->autoauto- [数组中重复的数字](#数组中重复的数字)auto- [二维数组中的查找](#二维数组中的查找)auto- [从尾到头打印链表](#从尾到头打印链表)auto- [重建二叉树](#重建二叉树)auto- [二叉树的下一个节点](#二叉树的下一个节点)auto- [用两个栈实现队列](#用两个栈实现队列)auto- [跳台阶](#跳台阶)auto- [跳台阶II](#跳台阶ii)auto- [矩形覆盖](#矩形覆盖)auto- [旋转数组的最小数字](#旋转数组的最小数字)auto- [矩阵中的路径](#矩阵中的路径)auto- [整数拆分(动态规划|贪心)](#整数拆分动态规划贪心)auto- [二进制中1的个数（位运算）](#二进制中1的个数位运算)auto- [数值的整数次方（位运算）](#数值的整数次方位运算)auto- [删除链表中重复的节点](#删除链表中重复的节点)auto- [调整数组顺序使奇数位于偶数前面（数组）](#调整数组顺序使奇数位于偶数前面数组)auto- [链表中倒数第k个结点](#链表中倒数第k个结点)auto- [链表中环的入口节点（链表）](#链表中环的入口节点链表)auto- [反转链表](#反转链表)auto- [合并两个排序的链表](#合并两个排序的链表)auto- [二叉树的镜像](#二叉树的镜像)auto- [对称的二叉树](#对称的二叉树)auto- [顺时针打印矩阵](#顺时针打印矩阵)auto- [包含min函数的栈（数据结构）](#包含min函数的栈数据结构)auto- [栈的压入、弹出序列](#栈的压入弹出序列)auto- [从上往下打印二叉树](#从上往下打印二叉树)auto- [把二叉树打印成多行](#把二叉树打印成多行)auto- [按之字形顺序打印二叉树](#按之字形顺序打印二叉树)auto- [二叉搜索树的后序遍历序列](#二叉搜索树的后序遍历序列)auto- [二叉搜索树的第k个结点](#二叉搜索树的第k个结点)auto- [二叉树中和为某一值的路径](#二叉树中和为某一值的路径)auto- [复杂链表的控制](#复杂链表的控制)auto- [平衡二叉树](#平衡二叉树)auto- [二叉搜索树与双向链表](#二叉搜索树与双向链表)auto- [序列化二叉树](#序列化二叉树)auto- [字符串的排列](#字符串的排列)auto- [数组中超过一半的数字](#数组中超过一半的数字)auto- [数组中第k大的元素](#数组中第k大的元素)auto- [数据流中的中位数](#数据流中的中位数)auto- [数字1的个数](#数字1的个数)auto- [连续子数组的最大和](#连续子数组的最大和)auto- [把数组排成最小的数](#把数组排成最小的数)auto- [把数字翻译成字符串（解码方法）](#把数字翻译成字符串解码方法)auto- [礼物的最大价值](#礼物的最大价值)auto- [丑数](#丑数)auto- [丑数II](#丑数ii)auto- [第一个只出现一次的字符](#第一个只出现一次的字符)auto- [字符流中第一个只出现一次的字符](#字符流中第一个只出现一次的字符)auto- [替换空格](#替换空格)auto- [翻转单词序列](#翻转单词序列)auto- [不用加减乘除做加法](#不用加减乘除做加法)auto- [扑克牌顺子](#扑克牌顺子)autoauto<!-- /TOC -->
## 数组中重复的数字
