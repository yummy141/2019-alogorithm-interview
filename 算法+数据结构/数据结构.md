目录
---
<!-- TOC -->autoauto- [二叉树的深度](#二叉树的深度)auto- [二叉树的宽度（求第K层的结点个数）](#二叉树的宽度求第k层的结点个数)auto- [二叉树的最小深度](#二叉树的最小深度)auto- [二叉树的层次遍历](#二叉树的层次遍历)auto- [二叉树的最大宽度](#二叉树的最大宽度)auto- [将有序数组转换为二叉搜索树](#将有序数组转换为二叉搜索树)auto- [二叉树的中序遍历](#二叉树的中序遍历)auto- [树的子结构](#树的子结构)auto- [重建二叉树](#重建二叉树)auto- [序列化二叉树](#序列化二叉树)auto- [二叉树的最近公共祖先](#二叉树的最近公共祖先)auto- [旋转链表](#旋转链表)auto- [反转链表](#反转链表)auto- [合并两个有序的链表](#合并两个有序的链表)auto- [链表排序](#链表排序)auto- [缺失的第一个正数](#缺失的第一个正数)auto- [搜索二维矩阵](#搜索二维矩阵)auto- [搜索二维矩阵II](#搜索二维矩阵ii)auto- [LRU](#lru)autoauto<!-- /TOC -->
## 二叉树的深度
