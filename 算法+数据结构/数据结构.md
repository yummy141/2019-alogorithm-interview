...
10、[合并两个有序的链表](https://www.nowcoder.com/practice/d8b6b4358f774294a89de2a6ac4d9337?tpId=13&tqId=11169&tPage=1&rp=3&ru=/ta/coding-interviews&qru=/ta/coding-interviews/question-ranking)
```c++
/*
struct ListNode {
	int val;
...
11、[链表排序](https://leetcode-cn.com/problems/sort-list/comments/)
快排
```c++
/**
 * Definition for singly-linked list.
...
12、[搜索二维矩阵I]（https://leetcode-cn.com/problems/search-a-2d-matrix/description/）
```C++
class Solution {
public:
...
13、[搜索二维矩阵II](https://leetcode-cn.com/problems/search-a-2d-matrix-ii/submissions/)
```c++
class Solution {
public:
    bool searchMatrix(vector<vector<int>>& matrix, int target) {
